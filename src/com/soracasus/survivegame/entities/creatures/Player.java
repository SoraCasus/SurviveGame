...
public class Player extends Creature {
	...
	public Player(Handler handler, float x, float y) {
		...
		//Animatons
		animDown = new Animation(500, Assets.INSTANCE.getAnimation("player_down"));
		animUp = new Animation(500, Assets.INSTANCE.getAnimation("player_up"));
		animLeft = new Animation(500, Assets.INSTANCE.getAnimation("player_left"));
		animRight = new Animation(500, Assets.INSTANCE.getAnimation("player_right"));
