...
public abstract class Item {
	...
	public static RedFruitItem redFruitItem = new RedFruitItem(Handler.instance);
	public static RedFruitSeedsItem redFruitSeedsItem = new RedFruitSeedsItem(Handler.instance);
